...
var Icon$X = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/egg/logo.svg" })));
};
...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/egg/aurum.svg" })));
};

var Icon$Q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/egg/mist.svg" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 300 40" }, props),
        React__default['default'].createElement("image", { width: "300", height: "40", href: isDark ? "/images/egg/LogoTextNewDark.png" : "/images/egg/LogoTextNewWhite.png" })));
};
...
var Icon$g = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512.017 512.017" }, props),
        React__default['default'].createElement("circle", { cx: "376.009", cy: "105.019", r: "15" }),
        React__default['default'].createElement("circle", { cx: "436.009", cy: "45.019", r: "45" }),
        React__default['default'].createElement("path", { d: "m466.009 270.019h-20.815c-5.125-21.072-13.401-41.342-25.393-60h-58.792c0 33.091-26.909 60-60 60s-60-26.909-60-60h-148.9c-11.907 18.545-20.156 38.84-25.278 60h-20.822c-8.291 0-15 6.709-15 15s6.709 14.99 15 14.99h16.091c-.394 4.997-1.091 9.941-1.091 15 0 53.165 21.248 103.207 55.662 138.323l-23.216 35.469c-4.526 6.929-2.593 16.23 4.336 20.771 6.892 4.501 16.194 2.635 20.771-4.336l21-32.084c32.576 24.278 72.894 38.807 116.783 38.807 43.365-.046 83.641-14.339 116.274-38.557l20.835 31.833c4.585 6.982 13.89 8.829 20.771 4.336 6.929-4.541 8.862-13.843 4.336-20.771l-23.064-35.237c33.667-34.299 54.895-83.231 55.507-136.427.066-5.77-.626-11.424-1.075-17.119h16.079c8.291 0 15-6.709 15-15s-6.708-14.998-14.999-14.998z" }),
        React__default['default'].createElement("path", { d: "m436.009 150.019h-105v-15c0-41.4-33.6-75-75-75-25.201 0-47.4 12.6-61.199 31.8-4.501-1.201-9.001-1.8-13.801-1.8-.004 0-.009.002-.013.002l-62.99-83.996c-4.98-6.665-14.399-7.998-20.991-3.003-6.636 4.966-7.983 14.37-3.003 20.991l56.138 74.859c-17.364 10.543-29.141 29.458-29.141 51.147h-45c-8.284 0-15 6.714-15 15 0 8.284 6.716 15 15 15h165c16.499 0 30 13.5 30 30s13.5 30 30 30 30-13.5 30-30v-30h105c8.284 0 15-6.716 15-15 0-8.286-6.717-15-15-15z" })));
};

var Icon$f = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512.001 512.001" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "m163.748 231.581c1.586 5.936 6.639 10.285 12.709 11.01l83.051 9.902 9.902 83.051c.729 6.156 5.176 11.153 11.01 12.709 5.934 1.584 12.222-.601 15.899-5.5l50.092-66.974 76.866 32.948c5.645 2.413 12.182 1.161 16.522-3.179s5.594-10.876 3.181-16.522l-32.95-76.866 66.974-50.092c4.9-3.677 7.086-9.965 5.5-15.899-1.584-5.936-6.639-10.307-12.709-11.01l-83.049-9.902-9.902-83.051c-.716-6.081-5.076-11.125-11.012-12.709-5.934-1.586-12.222.601-15.899 5.5l-50.09 66.974-76.868-32.948c-5.645-2.415-12.18-1.161-16.522 3.179-4.34 4.34-5.592 10.876-3.179 16.522l32.948 76.866-66.974 50.092c-4.899 3.677-7.083 9.965-5.5 15.899z" }),
            React__default['default'].createElement("path", { d: "m439.8 93.416 21.213-21.213c5.863-5.863 5.863-15.35 0-21.213-5.861-5.863-15.35-5.863-21.213 0l-21.213 21.213c-5.863 5.863-5.863 15.352 0 21.213 5.863 5.863 15.35 5.863 21.213 0z" }),
            React__default['default'].createElement("path", { d: "m288.191 58.479c8.005-2.144 12.75-10.369 10.605-18.375l-7.767-28.982c-2.166-8.007-10.369-12.751-18.376-10.607-8.005 2.144-12.75 10.369-10.605 18.375l7.767 28.982c2.123 7.93 10.306 12.757 18.376 10.607z" }),
            React__default['default'].createElement("path", { d: "m358.065 319.272c-8.007 2.144-12.751 10.369-10.607 18.375l7.769 28.982c2.122 7.93 10.305 12.757 18.375 10.607 8.007-2.144 12.751-10.369 10.607-18.375l-7.769-28.982c-2.155-7.995-10.378-12.762-18.375-10.607z" }),
            React__default['default'].createElement("path", { d: "m182.125 135.563-28.982-7.767c-8.007-2.144-16.232 2.598-18.376 10.605-2.151 8.082 2.688 16.256 10.607 18.375l28.982 7.769c8.007 2.144 16.23-2.6 18.375-10.607 2.133-8.017-2.632-16.242-10.606-18.375z" }),
            React__default['default'].createElement("path", { d: "m453.524 223.814c-2.151 8.08 2.688 16.254 10.607 18.375l28.982 7.767c8.007 2.144 16.23-2.598 18.375-10.605s-2.64-16.252-10.605-18.375l-28.982-7.769c-8.008-2.144-16.233 2.6-18.377 10.607z" }),
            React__default['default'].createElement("path", { d: "m25.611 507.603c5.861 5.863 15.35 5.863 21.213 0l190.204-190.202-4.519-37.908-37.905-4.519-190.208 190.204c-5.861 5.863-5.861 15.35 0 21.213z" }))));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/alchemistdefi/",
            },
            {
                label: "Docs",
                href: "https://alchemistdefi.gitbook.io/alchemis-defi/",
            },
            {
                label: "Blog",
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/alchemistdefi",
            },
            {
                label: "Announcements",
                href: "https://t.me/alchemistdefiann",
            },
        ],
    },
    {
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark; _a.cakePriceUsd; var mistPriceUsd = _a.mistPriceUsd, aurumPriceUsd = _a.aurumPriceUsd; _a.currentLang; _a.langs; _a.setLang; _a.priceLink; var mistPriceLink = _a.mistPriceLink, aurumPriceLink = _a.aurumPriceLink;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            mistPriceUsd ? (React__default['default'].createElement(PriceLink, { href: mistPriceLink, target: "_blank" },
            ...
            aurumPriceUsd ? (React__default['default'].createElement(PriceLink, { href: aurumPriceLink, target: "_blank" },
        ...
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                React__default['default'].createElement(Flex, { alignItems: "center" },
                    React__default['default'].createElement(SunIcon, { color: isDark ? "textDisabled" : "text", width: "22px" }),
                    React__default['default'].createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                    React__default['default'].createElement(MoonIcon, { color: isDark ? "text" : "textDisabled", width: "22px" }))),
            React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
                var Icon = Icons[social.icon];
                var iconProps = { width: "22px", color: "textSubtle", style: { cursor: "pointer" } };
